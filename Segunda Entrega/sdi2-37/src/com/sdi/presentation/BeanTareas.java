...
public class BeanTareas implements Serializable {
	...
	public void init() throws BusinessException {
		...
		categorias = Services.getCategoryService().findCategoriesByUserId(
				u.getId());
	}
	...
	public String listarTareasInbox() {
		...
		try {
			...
			tareas = Services.getTaskService()
	...
	public String nombreCategoria(Long id) {
		...
		try {
			...
			categoria = Services.getCategoryService().findCategoryById(id)
					.getName();
		} catch (BusinessException e) { }
	...
	public String getCategoriaId(Category c) {		
		if(c.getId() != null){
			return c.getName();
		}
		return "";
	...
	public void mostrarFinalizadas() {
		...
		try {
			tareasFinalizadas = Services.getTaskService()
	...
	public void editarTarea(Task t) {		
		try {		
			Services.getTaskService().updateTask(t);
