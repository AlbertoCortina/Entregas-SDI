...
<html><head> <title>TaskManager - Registrese </title>
<body>
  <form action="realizarRegistro" method="post">
 	...
 	<table align="center">
    	<tr> 
	    	...
	    	<td><input type="text" name="login" align="left" size="15" required="required"></td>
	    	<td align="right">Email</td>
	    	<td><input type="text" name="email" align="left" size="15"></td>
	    	<td align="right">Password</td>
	    	<td><input type="text" name="password" align="left" size="15"></td>
      		<td align="right">Password</td>
	    	<td><input type="text" name="passwordRepetida" align="left" size="15"></td>
      	</tr>
      	<tr>
